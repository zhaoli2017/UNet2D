...
class UNet2D(nn.Module):
    def __init__(self, in_dim=1, out_dim=3, num_filters=4):
        ...
        # Output
        self.out = conv_block_2d(self.num_filters, out_dim, nn.Softmax(dim=1))
...
if __name__ == "__main__":
    ...
    model = UNet2D(in_dim=1, out_dim=3, num_filters=4)
